  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({name: 'principlesHeading', title: '使用手册标题', type: 'string'}),
        defineField({name: 'principlesPdfLabel', title: '使用手册 PDF 按钮', type: 'string'}),
        defineField({name: 'allLabel', title: '“全部”按钮', type: 'string'}),
        defineField({name: 'loadError', title: '加载失败提示', type: 'string'}),
...
const visualization = defineType({
  ...
  fields: [
    ...
    defineField({name: 'instructions', title: '简介与使用说明', type: 'blockContent'}),
    defineField({
      name: 'principlesPdf',
      title: '使用手册 PDF',
      type: 'file',
