...
const uiSettings = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'object',
      fields: [
        defineField({name: 'backResearch', title: '返回科学研究', type: 'string'}),
        defineField({name: 'backCommunity', title: '返回科学社区', type: 'string'}),
